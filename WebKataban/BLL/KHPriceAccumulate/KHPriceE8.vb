        ...
        Try
            ...
            Select Case True
                Case bolOptionF = True
                    ...
                    strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 2) & "*00" & CdCst.Sign.Hypen & "F"
                ...
                Case bolOptionF1 = True
                    '基本価格キー
                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 2) & "*00" & CdCst.Sign.Hypen & "F1"
                ...
                Case bolOptionFF = True
                    '基本価格キー
                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 2) & "*00" & CdCst.Sign.Hypen & "FF"
                ...
                Case bolOptionFF1 = True
                    '基本価格キー
                    ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 2) & "*00" & CdCst.Sign.Hypen & "FF1"
                ...
                Case Else
                    ...
                    If bolOptionY = True Then
                        If Mid(strOpRefKataban(UBound(strOpRefKataban)).Trim, 6, 1) = CdCst.Sign.Hypen Then
                            strOpRefKataban(UBound(strOpRefKataban)) = strOpRefKataban(UBound(strOpRefKataban)) & "Y"
                        Else
