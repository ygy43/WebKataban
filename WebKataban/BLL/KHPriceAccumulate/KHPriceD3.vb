...
Module KHPriceD3
    ...
    Public Sub subPriceCalculation(ByVal objKtbnStrc As KHKtbnStrc, _
        ...
        '    '制御ユニット価格キー
        '    '制御ユニット付のものは加算
        '    If objKtbnStrc.strcSelection.strKeyKataban.Trim = "4" Or _
        '       objKtbnStrc.strcSelection.strKeyKataban.Trim = "5" Or _
        '       objKtbnStrc.strcSelection.strKeyKataban.Trim = "9" Then
        '        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
        '        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
        '        strOpRefKataban(UBound(strOpRefKataban)) = "CMF1" & "-UNIT-" & objKtbnStrc.strcSelection.strOpSymbol(5).Trim
        '        decOpAmount(UBound(decOpAmount)) = 1
        '    ElseIf objKtbnStrc.strcSelection.strKeyKataban.Trim = "6" Or _
        '           objKtbnStrc.strcSelection.strKeyKataban.Trim = "7" Then
        '        ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
        '        ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
        ...
        '    If objKtbnStrc.strcSelection.strKeyKataban.Trim = "1" Or _
        '       objKtbnStrc.strcSelection.strKeyKataban.Trim = "2" Or _
        '       objKtbnStrc.strcSelection.strKeyKataban.Trim = "3" Or _
        '       objKtbnStrc.strcSelection.strKeyKataban.Trim = "8" Then
