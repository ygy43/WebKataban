...
Module KHPrice97
    ...
    Public Sub subPriceCalculation(ByVal objKtbnStrc As KHKtbnStrc, _
        ...
        Try
            ...
            'バリエーション加算価格キー
            '(*V*)バルブ付
            If objKtbnStrc.strcSelection.strSeriesKataban.Trim = "JSG-V" Then
                ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 3) & "-VAR-V-" & _
            ...
            If objKtbnStrc.strcSelection.strOpSymbol(3).Trim <> "" Then
                ...
                ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                strOpRefKataban(UBound(strOpRefKataban)) = Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 3) & "-SCREW-" & _
                ...
                If objKtbnStrc.strcSelection.strOpSymbol(8).Trim <> "" Then
                    Select Case objKtbnStrc.strcSelection.strOpSymbol(7).Trim
                        Case "T2H", "T2V", "T2YH", "T2YV", "T3H", _
                             ...
                             "T5H", "T5V", "T2JH", "T2JV", "T1H", "T1V", _
                             "T8H", "T8V", "T2WH", "T2WV", "T3WH", "T3WV", _
                             "T3PH", "T3PV"
                            ReDim Preserve strOpRefKataban(UBound(strOpRefKataban) + 1)
                            ReDim Preserve decOpAmount(UBound(decOpAmount) + 1)
                            ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
