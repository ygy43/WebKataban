    ...
    Public Sub subPriceCalculation(ByVal objKtbnStrc As KHKtbnStrc, _
        ...
        Try
            ...
            If (objKtbnStrc.strcSelection.strOpSymbol(8).Trim <> "") Then
                ...
                strOpRefKataban(UBound(strOpRefKataban)) = _
                    Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & _
                    CdCst.Sign.Hypen & "N" & CdCst.Sign.Hypen & _
            ...
            If objKtbnStrc.strcSelection.strOpSymbol(4).Trim.Length <> 0 Then
                ...
                If objKtbnStrc.strcSelection.strOpSymbol(7).Trim.Length <> 0 Then
                    ...
                    ReDim Preserve strPriceDiv(UBound(strPriceDiv) + 1)
                    strOpRefKataban(UBound(strOpRefKataban)) = _
                        Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & CdCst.Sign.Hypen & _
                ...
                If objKtbnStrc.strcSelection.strOpSymbol(5).Trim.Length <> 0 Then
                    ...
                    If objKtbnStrc.strcSelection.strOpSymbol(4).Trim = "T2YD" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                        Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & _
                        CdCst.Sign.Hypen & "N" & CdCst.Sign.Hypen & "T2YD" & CdCst.Sign.Hypen & _
                        objKtbnStrc.strcSelection.strOpSymbol(5).Trim

                    ElseIf objKtbnStrc.strcSelection.strOpSymbol(4).Trim = "T2YDT" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & _
                         CdCst.Sign.Hypen & "N" & CdCst.Sign.Hypen & "T2YDT" & CdCst.Sign.Hypen & _
                         objKtbnStrc.strcSelection.strOpSymbol(5).Trim

                    ElseIf objKtbnStrc.strcSelection.strOpSymbol(4).Trim = "T2JH" Or _
                    objKtbnStrc.strcSelection.strOpSymbol(5).Trim = "T2JV" Then
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & _
                         CdCst.Sign.Hypen & "N" & CdCst.Sign.Hypen & "T2J" & CdCst.Sign.Hypen & _
                         objKtbnStrc.strcSelection.strOpSymbol(5).Trim
                    Else
                        strOpRefKataban(UBound(strOpRefKataban)) = _
                         Left(objKtbnStrc.strcSelection.strSeriesKataban.Trim, 4) & _
                         CdCst.Sign.Hypen & "N" & CdCst.Sign.Hypen & "T" & CdCst.Sign.Hypen & _
                         objKtbnStrc.strcSelection.strOpSymbol(5).Trim
                    End If
